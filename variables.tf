...
variable consul01ext { default = "10.90.2.102" }
...
variable FAST_URL {default = "https://github.com/F5Networks/f5-appsvcs-templates/releases/download/v1.2.0/f5-appsvcs-templates-1.2.0-1.noarch.rpm" }
